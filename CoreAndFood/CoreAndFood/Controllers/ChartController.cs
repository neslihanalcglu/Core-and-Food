...
namespace CoreAndFood.Controllers
{
    public class ChartController : Controller
    {
        ...
        public List<Class2> FoodList()
        {
            ...
            using (var c = new Context())//Context sınıfını kullan
            {
        ...
        public IActionResult Statistics()
        {
            ...
            var deger4 = c.Foods.Where(x => x.CategoryId == c.Categories.Where(z => z.CategoryName == "Sebzeler").Select(y => y.CategoryId).FirstOrDefault()).Count();
            ViewBag.d4 = deger4;
